  ...
  <div class="row">
    <div class="col-md-6">
        ...
        <div class="banner-text">
          ...
          <p class="bt4">our store dolor sit amet, consectetur adipiscing elit. Vestibulum et mi <br>vulputate gen vehicula maximus sagittis rhoncus tortor. Class </p>
    ...
    <div class="topsell-head">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h4>All Products</h4>
          <p>A passage of our store you need here</p>
      ...
      <div class="col-md-12 col-lg-6 col-sm-12">
        ...
        <div class="row" id="wel1">
          ...
          <div class="col-md-10  col-lg-10 col-10">
            ...
            <p class="wp">There are many variations of passages our store available<br>
